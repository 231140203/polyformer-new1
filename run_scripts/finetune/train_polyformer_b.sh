...
data=${data_dir}/nnunet/nnunet_train_shuffled.tsv,${data_dir}/nnunet/nnunet_val.tsv
selected_cols=0,5,6,2,4,3,7
restore_file=${save_dir}/100_5e-5_512/checkpoint_best_mdice.pt
  ...
  for lr in 5e-5; do
    ...
    for patch_image_size in 512; do
      ...
      CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.launch --nproc_per_node=1 --master_port=${MASTER_PORT} ../../train.py \
          ...
          --save-interval=3 --validate-interval=1 \
          --valid-subset=nnunet_val \
